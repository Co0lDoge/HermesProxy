...
public partial class WorldClient
{
    ...
    void HandleMoveTeleportBroadcast(WorldPacket packet)
    {
        ...
        // MSG_MOVE_TELEPORT for the player rather than the ACK variant, so
        // HandleMoveTeleportAck never fires and the client stays in
        // server-controlled flight state. Restore control here so the client
        // can move again without relog — issue #73.
